...
try {
    ...
    if ($lastHealth.resultSchemaVersion -ne 9) {
        throw "Health endpoint did not report result schema version 9"
    }
    ...
    if ($first.schemaVersion -ne 9) {
        throw "PCM response did not report result schema version 9"
    }
    ...
    if ($fullArchive.records[0].schemaVersion -ne 9) {
        throw "Archived result record did not preserve result schema version 9"
    }

...
- Continue MHT porting: bearing/correlation/peak-frequency chi2 variables, the MHT kernel/TrackBitSet, and StandardMHTChi2 combination (`docs/166`, `docs/167`).

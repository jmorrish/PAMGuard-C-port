...
- Continue MHT porting: StandardMHTChi2 combination over the ported kernel and chi2 variables, bearing/correlation/peak-frequency variables, and session wiring as an alternative train former (`docs/166`-`docs/168`).

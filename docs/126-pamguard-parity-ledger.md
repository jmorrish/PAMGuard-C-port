...
- Serve the ported `MLGridBearingLocaliser2` for `grid` selections, replacing the LSQ substitution: needs per-hydrophone coordinate errors in session config (`docs/195-ml-grid-bearing-localiser.md`).

...
- Expose the bearing classifier in the served config surface and apply classification to ICI-tracker trains as well as MHT trains (`docs/187-ct-classifier-service-wiring.md`).

...
- Port `MLGridBearingLocaliser2`, the localiser PAMGuard actually selects for plane and volume sub-arrays; the selection is ported but the engine substitutes LSQ for it (`docs/194-bearing-localiser-selection.md`).

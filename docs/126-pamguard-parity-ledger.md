...
- Carry world vectors on pair and LSQ bearings too, and add the GPS/attitude feed `getRealWorldVectors` needs to reach an earth frame (`docs/197-world-vectors.md`).

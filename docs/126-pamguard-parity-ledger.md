...
- Port the remaining MHT pieces: correlation and time-delay chi2 variables, the electrical noise filter, and click train classification (`docs/166`-`docs/173`).

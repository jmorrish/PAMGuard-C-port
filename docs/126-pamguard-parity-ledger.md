...
- Port the remaining MHT pieces: the correlation chi2 variable (needs PAMGuard's waveform CorrelationManager), wiring time-delay/correlation variables into the served stack, and click train classification (`docs/166`-`docs/176`).

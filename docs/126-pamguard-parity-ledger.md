...
- Deepen the served MHT path: wire the ported bearing/peak-frequency variables into the served stack, add per-session MHT parameters, and port correlation/time-delay variables, the electrical noise filter, and click train classification (`docs/166`-`docs/172`).

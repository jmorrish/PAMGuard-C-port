...
- Deepen the served MHT path: per-session MHT parameters, remaining chi2 variables (bearing/correlation/time-delay/peak-frequency), the electrical noise filter, and click train classification (`docs/166`-`docs/171`).

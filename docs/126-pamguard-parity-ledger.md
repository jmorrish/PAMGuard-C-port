...
- Finish the click train work: port the template classifier (spectrum-template matched filtering) and wire the classifier chain into the served MHT path (`docs/166`-`docs/184`).

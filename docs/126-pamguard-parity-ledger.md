...
- Wire the ported MHT stack into the session/service as an alternative train former, and port the remaining chi2 variables (bearing/correlation/time-delay/peak-frequency) and electrical noise filter (`docs/166`-`docs/169`).

...
- Wire LSQ bearing localiser selection for four-plus hydrophone sessions into the click pipeline (pair bearing is exposed at schema v5) and aggregate pair bearings into train-level summaries.

...
- Wire the ported classifier chain into the served MHT path, including train average-spectrum construction and PAMGuard's default spectrum templates (`docs/166`-`docs/185`).

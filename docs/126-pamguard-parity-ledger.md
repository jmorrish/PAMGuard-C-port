...
- Deepen the served MHT path: kernel garbage reclamation for long streams, per-session MHT parameters, remaining chi2 variables (bearing/correlation/time-delay/peak-frequency), and the electrical noise filter (`docs/166`-`docs/170`).

...
$Output = Join-Path $PortRoot "cpp-engine\tests\fixtures\whistle\connected-region-rejoin.csv"
...
& $Java -cp $BuildDir org.pamguard.port.reference.ConnectedRegionRejoinFixtureExporter $Output
if ($LASTEXITCODE -ne 0) {

...
$Output = Join-Path $PortRoot "cpp-engine\tests\fixtures\whistle\better-peak-basic.csv"
$JavaSrc = Join-Path $PortRoot "reference-tools\java\src\org\pamguard\port\reference\WhistlePeakFixtureExporter.java"
...
& $Java -cp $BuildDir org.pamguard.port.reference.WhistlePeakFixtureExporter `
    128 `
    64 `
    48000 `
    $Output

...
$JavaSrc = Join-Path $PortRoot "reference-tools\java\src\org\pamguard\port\reference\NoiseBandFixtureExporter.java"
...
& $Java -cp "$BuildDir;$TargetClasses;$DependencyClasspath" org.pamguard.port.reference.NoiseBandFixtureExporter $Output
if ($LASTEXITCODE -ne 0) {

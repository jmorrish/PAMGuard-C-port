...
$Output = Join-Path $PortRoot "cpp-engine\tests\fixtures\whistle\connected-region-rejoin-cross.csv"
...
& $Java -cp $BuildDir org.pamguard.port.reference.ConnectedRegionRejoinFixtureExporter $Output cross
if ($LASTEXITCODE -ne 0) {

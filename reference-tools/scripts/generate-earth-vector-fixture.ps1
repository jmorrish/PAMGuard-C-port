...
$Output = Join-Path $PortRoot "cpp-engine\tests\fixtures\localisation\earth-vector.csv"
...
& $Java -cp "$BuildDir;$TargetClasses;$DependencyClasspath" org.pamguard.port.reference.WorldVectorFixtureExporter $Output earth
if ($LASTEXITCODE -ne 0) {
